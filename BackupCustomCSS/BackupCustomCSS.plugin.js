...
let {env: {DISCORD_RELEASE_CHANNEL}, platform} = process,
    ...
    {join} = require("path"),
    {ButtonLooks, ButtonColors, ButtonSizes} = Button = BdApi.findModuleByProps("ButtonLooks"),
    ...
    markdown = BdApi.findModuleByDisplayName("Markdown")
...
class SettingsPanel extends Component {
    constructor() {
        super(...arguments)
        this.state = {Path: folder, ResetButtonHover: false}
    }
    render() {
        return createElement("div", {
                ...
                createElement(Group, {
                    ...
                    children: [
                        createElement(Switch, {
                            id: "QuickSettings",
                            value: loadData("BackupCustomCSS", "QuickSettings") ?? true, 
                        ...
                        createElement(Switch, {
                            id: "QuickOpen",
                            value: loadData("BackupCustomCSS", "QuickOpen") ?? true, 
...
module.exports = class BackupCustomCSS{
    ...
    observer() {
        if(document.getElementById("bd-editor-controls") && !document.getElementById("BackupCustomCSS")) {
            ...
            ele.onclick = (e) => {
                if(e.shiftKey === true && loadData("BackupCustomCSS", "QuickSettings") === true) this.showSettingsModal()
                else if(e.ctrlKey === true || e.metaKey === true && loadData("BackupCustomCSS", "QuickOpen") === true) openPath(join(folder, "BackupCustomCSS", DISCORD_RELEASE_CHANNEL))
